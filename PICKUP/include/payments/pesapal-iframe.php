...
*/
$consumer_key = 'eVh3Ti0Iqd4dfg8XKanKw3mHD9tR8JPt';//Register a merchant account on

                   //demo.pesapal.com and use the merchant key for testing.
                   //When you are ready to go live make sure you change the key to the live account
                   //registered on www.pesapal.com!
$consumer_secret = 'UemyIQardAEfVJamyUQH1JGJS+I=';// Use the secret from your test
...
$callback_url = 'http://google.com'; //redirect url, the page that will handle the response from pesapal.
